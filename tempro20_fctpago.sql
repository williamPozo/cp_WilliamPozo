...
--
-- Table structure for table `fctpago`
--

DROP TABLE IF EXISTS `fctpago`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fctpago` (
...
--
-- Dumping data for table `fctpago`
--

LOCK TABLES `fctpago` WRITE;
/*!40000 ALTER TABLE `fctpago` DISABLE KEYS */;
/*!40000 ALTER TABLE `fctpago` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-10-30 17:38:41
