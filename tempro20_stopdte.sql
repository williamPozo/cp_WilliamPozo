...
--
-- Table structure for table `stopdte`
--

DROP TABLE IF EXISTS `stopdte`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `stopdte` (
  ...
  `pdtnomp` varchar(100) DEFAULT NULL,
  `pdtmedart` char(30) DEFAULT '',
  `pdtserie1` char(3) DEFAULT '',
  `pdtserie2` char(3) DEFAULT '',
  `panno` int(4) NOT NULL,
  `pdtcue4` char(30) DEFAULT NULL,
  `pdtcue5` char(30) DEFAULT NULL,
  PRIMARY KEY (`iddet`,`pdtcom`,`bodart`),
...
--
-- Dumping data for table `stopdte`
--

LOCK TABLES `stopdte` WRITE;
/*!40000 ALTER TABLE `stopdte` DISABLE KEYS */;
/*!40000 ALTER TABLE `stopdte` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-10-30 17:38:39
