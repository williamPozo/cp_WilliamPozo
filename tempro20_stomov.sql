...
--
-- Table structure for table `stomov`
--

DROP TABLE IF EXISTS `stomov`;
...
--
-- Dumping data for table `stomov`
--

LOCK TABLES `stomov` WRITE;
/*!40000 ALTER TABLE `stomov` DISABLE KEYS */;
/*!40000 ALTER TABLE `stomov` ENABLE KEYS */;
UNLOCK TABLES;
