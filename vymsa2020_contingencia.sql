...
CREATE TABLE `contingencia` (
  `conti_clave` char(37) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT '',
  `conti_id` int(6) NOT NULL AUTO_INCREMENT,
  `conti_usa` int(1) DEFAULT '0',
  PRIMARY KEY (`conti_id`)
...
-- Dump completed on 2020-10-30 17:42:30
