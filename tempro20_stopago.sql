...
--
-- Table structure for table `stopago`
--

DROP TABLE IF EXISTS `stopago`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `stopago` (
  `idpago` int(11) NOT NULL AUTO_INCREMENT,
  `pagnumero` int(11) DEFAULT '0',
  `pagclave` char(13) NOT NULL,
  `pagbodega` char(5) DEFAULT '',
  `pagfactura` int(10) NOT NULL DEFAULT '0',
  ...
  PRIMARY KEY (`idpago`,`pagclave`,`pagfactura`,`panno`),
  UNIQUE KEY `idpago` (`idpago`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `stopago`
--

LOCK TABLES `stopago` WRITE;
/*!40000 ALTER TABLE `stopago` DISABLE KEYS */;
/*!40000 ALTER TABLE `stopago` ENABLE KEYS */;
UNLOCK TABLES;
