...
--
-- Table structure for table `stopdtres`
--

DROP TABLE IF EXISTS `stopdtres`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `stopdtres` (
  ...
  `pdtdcto` decimal(10,4) DEFAULT '0.0000',
  `pdtdctog` decimal(10,4) DEFAULT '0.0000',
  ...
  PRIMARY KEY (`iddet`,`pdtcod`,`pdtcom`,`pdtbod`,`pdtart`,`pdtalt`,`pdtcla`,`pdtlot`,`pdtubic`,`pdtcomp`,`bodart`,`bodegafc`,`pdtserie1`,`pdtserie2`),
  ...
  KEY `fk_bodegacli` (`pdtcla`,`pdtcomp`,`bodegafc`)
) ENGINE=MyISAM AUTO_INCREMENT=12 DEFAULT CHARSET=latin1 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `stopdtres`
--

LOCK TABLES `stopdtres` WRITE;
/*!40000 ALTER TABLE `stopdtres` DISABLE KEYS */;
/*!40000 ALTER TABLE `stopdtres` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-10-30 17:41:10
