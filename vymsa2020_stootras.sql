...
--
-- Table structure for table `stootras`
--

DROP TABLE IF EXISTS `stootras`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `stootras` (
  ...
  PRIMARY KEY (`iddet`,`pdtcod`,`pdtcom`,`pdtbod`,`pdtart`,`pdtcomp`,`bodart`,`bodegafc`),
...
--
-- Dumping data for table `stootras`
--

LOCK TABLES `stootras` WRITE;
/*!40000 ALTER TABLE `stootras` DISABLE KEYS */;
/*!40000 ALTER TABLE `stootras` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-10-30 17:41:01
