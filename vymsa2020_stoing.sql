...
--
-- Table structure for table `stoing`
--

DROP TABLE IF EXISTS `stoing`;
...
CREATE TABLE `stoing` (
  ...
  `pdtcodre` char(3) NOT NULL DEFAULT '',
  ...
  `pdtnomp` varchar(80) DEFAULT '',
  `pdtmedart` char(30) DEFAULT '',
  `panno` int(4) NOT NULL,
  `pdtcue4` char(30) NOT NULL,
  `pdtcue5` char(30) NOT NULL,
  `pdtirbp` decimal(6,2) NOT NULL DEFAULT '0.00',
  PRIMARY KEY (`iddet`,`pdtcod`,`pdtcom`,`pdtbod`,`pdtart`,`pdtlot`,`pdtubic`,`pdtcomp`,`bodegafc`),
...
--
-- Dumping data for table `stoing`
--

LOCK TABLES `stoing` WRITE;
/*!40000 ALTER TABLE `stoing` DISABLE KEYS */;
INSERT INTO `stoing` VALUES (4,'EB',1,'2020-09-02','2020-09-02','03:12:10','01','HR-BAL-CHAUS','','5.02.01.24.02','5.01.01.01.01','4.01.01.01.02','02','08','','','','','','0000000000024','','',45,'','','','2020-09-02',50.000000,0.000000,1.000000,0.000000,690.000000,34500.000000,0.000000,0.00,0.00,0.000000,'DE00000001','2020-09-02',12.00,0.00,0,'','','01',0.000000,'01HR-BAL-CHAUS','0208','0208',0.000000,0.000000,0.000000,0.000000,'BODEGA','2020-09-02','03:12:10','BODEGA','2020-09-02','','','',0.000000,'','011EB','','','','','','','',0.000000,0.000000,'','','','','',0,0.000000,0.000000,0.000000,'',0.000000,0.000000,0.000000,'BALANZA OHAUS RANGER RC31P30                                                    ','',2020,'','',0.00);
/*!40000 ALTER TABLE `stoing` ENABLE KEYS */;
UNLOCK TABLES;
