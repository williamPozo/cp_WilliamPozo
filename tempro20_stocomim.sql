...
--
-- Table structure for table `stocomim`
--

DROP TABLE IF EXISTS `stocomim`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `stocomim` (
  `iddet` int(11) NOT NULL AUTO_INCREMENT,
  `pdtcod` char(2) NOT NULL DEFAULT '',
  `pdtcom` int(11) NOT NULL DEFAULT '0',
  `pdtfe_tr` date DEFAULT NULL,
  `pdtfe_co` date DEFAULT NULL,
  `pdthora` char(8) DEFAULT '',
  `pdtbod` char(5) NOT NULL DEFAULT '',
  `pdtart` char(20) NOT NULL DEFAULT '',
  `pdtalt` char(20) DEFAULT '',
  `pdtcue1` char(30) NOT NULL DEFAULT '',
  `pdtcue2` char(30) NOT NULL DEFAULT '',
  `pdtcue3` char(30) NOT NULL DEFAULT '',
  ...
  `pdtc_iva` int(1) DEFAULT '0' COMMENT 'para productos no obejtos de IVA',
  ...
  PRIMARY KEY (`iddet`,`pdtcod`,`pdtcom`,`pdtbod`,`pdtart`,`pdtlot`,`pdtubic`,`pdtcomp`,`bodart`,`bodegafc`),
...
) ENGINE=MyISAM AUTO_INCREMENT=25655 DEFAULT CHARSET=latin1 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `stocomim`
--

LOCK TABLES `stocomim` WRITE;
/*!40000 ALTER TABLE `stocomim` DISABLE KEYS */;
/*!40000 ALTER TABLE `stocomim` ENABLE KEYS */;
UNLOCK TABLES;
